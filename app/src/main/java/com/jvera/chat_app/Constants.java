...
public class Constants {
    ...
    */
    static String TXT_REGISTRATION_SUCCESSFUL = "Registration successful";
    static String TXT_REGISTRATION_SUCCESSFUL_WELCOME = "Registration successful. Welcome ";
     ...
     */
    static String API_URL_USERS_USERNAMES = "https://chat-app-f7685.firebaseio.com/users/usernames";
    public static String API_URL_USERS_USERNAMES_JSON = "https://chat-app-f7685.firebaseio.com/users/usernames.json";
    static String API_URL_GUESTS_USERNAMES = "https://chat-app-f7685.firebaseio.com/guests/usernames";
    static String API_URL_GUESTS_MESSAGES = "https://chat-app-f7685.firebaseio.com/guests/messages";
